...
function VehicleSort:getTextColor(index, realId)
	...
	elseif (g_currentMission.vehicles[realId].ad ~= nil and g_currentMission.vehicles[realId].ad.stateModule ~= nil and g_currentMission.vehicles[realId].ad.stateModule ~= nil and g_currentMission.vehicles[realId].ad.stateModule.active) then
